...
function ChatCard({chat}) {
  ...
  const { setActiveChat, setIsRemoveChatOpen } = useChat();
  const { setModalData } = useUser();
  ...
  return (
    <div className={`card`} onClick={() => setActiveChat(chat)}>
      ...
      <div className='card-btn'>
        <button className='remove-btn' onClick={() => openDeleteChatModal()}>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16" viewBox="0 0 256 256">
            <g fill="#87ceeb" stroke="none" transform="scale(10.66667,10.66667)">
        ...
        <button className='update-btn' onClick={() => openEditModal()}>
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16" viewBox="0 0 50 50" fill="#87ceeb" preserveAspectRatio="xMidYMid meet">
